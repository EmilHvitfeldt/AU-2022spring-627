...
We will have 10 weekly assignments, a midterm, and a final project in this class. The placement of these is located in the [schedule](schedule.html).
...
The project can be done in groups. Both groups and the data you want to use should be approved by email by me. Approval must happen no later than April 3rd.
